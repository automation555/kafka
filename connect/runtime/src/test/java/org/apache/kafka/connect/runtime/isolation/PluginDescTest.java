...
public class PluginDescTest {
    ...
    public void testRegularPluginDesc() {
        ...
        assertPluginDesc(transformDesc, SampleTransformation.class, noVersion, pluginLoader.location());
    }
    ...
    public void testPluginDescWithSystemClassLoader() {
        ...
        assertPluginDesc(transformDesc, SampleTransformation.class, noVersion, location);
    }
    ...
    public void testPluginDescEquality() {
        ...
        PluginDesc<SampleTransformation> transformDescPluginPath = new PluginDesc<>(
                SampleTransformation.class,
                null,
                pluginLoader
        );

        PluginDesc<SampleTransformation> transformDescClasspath = new PluginDesc<>(
                SampleTransformation.class,
                noVersion,
                pluginLoader
        );
