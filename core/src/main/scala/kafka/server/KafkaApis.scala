...
import kafka.api.{ApiVersion, ElectLeadersRequestOps, KAFKA_0_11_0_IV0, KAFKA_2_3_IV0, KAFKA_2_8_IV1}
    ...
    val unauthorizedForDescribeTopicMetadata =
      ...
      if ((requestVersion == 0 && (metadataRequest.topics == null || metadataRequest.topics.isEmpty)) || metadataRequest.isAllTopics)
        ...
        unauthorizedForDescribeTopics.map(topic =>
          metadataResponseTopic(Errors.UNKNOWN_TOPIC_ID, null, metadataCache.getTopicId(topic), false, util.Collections.emptyList()))
      } else {
