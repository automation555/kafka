...
public class RemoteLogSegmentMetadataRecordUpdate implements ApiMessage {
    ...
    public static final Schema SCHEMA_0 =
        new Schema(
            ...
            new Field("event_timestamp_ms", Type.INT64, "Event timestamp in milli seconds of this segment."),
            new Field("remote_log_segment_state", Type.INT8, "State of the remote segment")
        );
    ...
    public RemoteLogSegmentMetadataRecordUpdate(Readable _readable, short _version) {
        read(_readable, _version);
    }
    
    public RemoteLogSegmentMetadataRecordUpdate() {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof RemoteLogSegmentMetadataRecordUpdate)) return false;
        RemoteLogSegmentMetadataRecordUpdate other = (RemoteLogSegmentMetadataRecordUpdate) obj;
    ...
    @Override
    public RemoteLogSegmentMetadataRecordUpdate duplicate() {
        RemoteLogSegmentMetadataRecordUpdate _duplicate = new RemoteLogSegmentMetadataRecordUpdate();
    ...
    public String toString() {
        return "RemoteLogSegmentMetadataRecordUpdate("
    ...
    public RemoteLogSegmentMetadataRecordUpdate setRemoteLogSegmentId(RemoteLogSegmentIdEntry v) {
        this.remoteLogSegmentId = v;
        return this;
    }
    
    public RemoteLogSegmentMetadataRecordUpdate setBrokerId(int v) {
        this.brokerId = v;
        return this;
    }
    
    public RemoteLogSegmentMetadataRecordUpdate setEventTimestampMs(long v) {
        this.eventTimestampMs = v;
        return this;
    }
    
    public RemoteLogSegmentMetadataRecordUpdate setRemoteLogSegmentState(byte v) {
    ...
    public static class TopicIdPartitionEntry implements Message {
        ...
        public static final Schema SCHEMA_0 =
            new Schema(
                new Field("name", Type.STRING, "Topic name"),
