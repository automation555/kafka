...
import static  org.apache.kafka.server.log.remote.metadata.storage.generated.RemoteLogSegmentMetadataRecordUpdate.*;

public class RemoteLogSegmentMetadataRecordUpdateJsonConverter {
    public static RemoteLogSegmentMetadataRecordUpdate read(JsonNode _node, short _version) {
        RemoteLogSegmentMetadataRecordUpdate _object = new RemoteLogSegmentMetadataRecordUpdate();
        JsonNode _remoteLogSegmentIdNode = _node.get("remoteLogSegmentId");
        if (_remoteLogSegmentIdNode == null) {
            throw new RuntimeException("RemoteLogSegmentMetadataRecordUpdate: unable to locate field 'remoteLogSegmentId', which is mandatory in version " + _version);
        } else {
        ...
        if (_brokerIdNode == null) {
            throw new RuntimeException("RemoteLogSegmentMetadataRecordUpdate: unable to locate field 'brokerId', which is mandatory in version " + _version);
        } else {
            _object.brokerId = MessageUtil.jsonNodeToInt(_brokerIdNode, "RemoteLogSegmentMetadataRecordUpdate");
        }
        JsonNode _eventTimestampMsNode = _node.get("eventTimestampMs");
        if (_eventTimestampMsNode == null) {
            throw new RuntimeException("RemoteLogSegmentMetadataRecordUpdate: unable to locate field 'eventTimestampMs', which is mandatory in version " + _version);
        } else {
            _object.eventTimestampMs = MessageUtil.jsonNodeToLong(_eventTimestampMsNode, "RemoteLogSegmentMetadataRecordUpdate");
        }
        JsonNode _remoteLogSegmentStateNode = _node.get("remoteLogSegmentState");
        if (_remoteLogSegmentStateNode == null) {
            throw new RuntimeException("RemoteLogSegmentMetadataRecordUpdate: unable to locate field 'remoteLogSegmentState', which is mandatory in version " + _version);
        } else {
            _object.remoteLogSegmentState = MessageUtil.jsonNodeToByte(_remoteLogSegmentStateNode, "RemoteLogSegmentMetadataRecordUpdate");
        }
        return _object;
    }
    public static JsonNode write(RemoteLogSegmentMetadataRecordUpdate _object, short _version, boolean _serializeRecords) {
    ...
    public static JsonNode write(RemoteLogSegmentMetadataRecordUpdate _object, short _version) {
